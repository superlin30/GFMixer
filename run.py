...
# NEW: GFMixer
parser.add_argument('--num_kernels', type=int, default=6, help='Inception setting')
parser.add_argument('--TGB', type=int, default=1, help='Enable Temporal Gradient Block (1: True, 0: False)')
parser.add_argument('--TGB_mode', type=str, default='all', help='Operating mode:all, Acc or Trend')
parser.add_argument('--use_FAT', type=int, default=1, help='whether to use Fourier-Aware Transformer block (1: True, 0: False)')
...
if __name__ == '__main__':
    ...
    torch.multiprocessing.freeze_support()   # Required for safe multiprocessing on Windows
